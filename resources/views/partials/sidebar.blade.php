    ...
    <ul class="nav">
      ...
      <li class="nav-item">
        ...
        <div class="collapse mt-1" id="form-elements">
          <ul class="nav flex-column sub-menu">
            <li class="nav-item"><a class="nav-link" href="{{ route('admin.Dashbord.create')}}">create in produit</a></li>
          </ul>
        </div>
      </li>
      ...
      <li class="nav-item">
        ...
        <div class="collapse mt-1" id="tables">
          <ul class="nav flex-column sub-menu">
            <li class="nav-item"> <a class="nav-link" href="{{route('admin.Dashbord.index')}}">Basic table</a></li>
          </ul>
        </div>
      </li>
